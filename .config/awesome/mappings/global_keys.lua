...
return gears.table.join(
	...
	-- Tag browsing
	awful.key({ modkey }, "#43", awful.tag.viewprev, { description = "View previous tag", group = "Tag" }),

	awful.key({ modkey }, "#46", awful.tag.viewnext, { description = "View next tag", group = "Tag" }),
